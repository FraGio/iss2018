...
Per l'utilizzo dell'infrastruttura meteo è stato valutato di utilizzare un servizio esterno (OpenWeatherMap), che offre diverse soluzioni di scalabilità (e di conseguenza costi) in base al n° di richieste effettuate al minuto. Per riferimento vedere https://www.openweathermap.org/price.\\
