...
In termini di applicazione GUI per pc ci sono due strade per realizzarla: mantenere tutto su pc, oppure avere solo la parte di visualizzazione e comando, con la parte applicativa spostata esternamente. In base alle nostre valutazioni decidiamo di intraprendere la seconda strada, ossia di avere la parte grafica della GUI su pc/smartphone e la parte più applicativa su un server esterno, questo perchè si ha più flessibilità per eventuali modifiche e facilità di implementazione di estensioni future della interfaccia.
