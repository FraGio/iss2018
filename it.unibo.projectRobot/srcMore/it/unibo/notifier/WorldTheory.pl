%==============================================
% WorldTheory.pl for actor notifier
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatunotifier).	%%old version (deprecated)
actorobj(qatunotifier).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor notifier
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of notifier" ). 
...
%-------------------------------------------------
%  User static rules about notifier
%------------------------------------------------- 
/*
------------------------------------------------------------------------
