%==============================================
% WorldTheory.pl for actor mapper
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumapper).	%%old version (deprecated)
actorobj(qatumapper).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mapper
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mapper" ). 
...
%-------------------------------------------------
%  User static rules about mapper
%------------------------------------------------- 
/*
------------------------------------------------------------------------
