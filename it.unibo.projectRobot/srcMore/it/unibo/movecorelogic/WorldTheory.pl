%==============================================
% WorldTheory.pl for actor movecorelogic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumovecorelogic).	%%old version (deprecated)
actorobj(qatumovecorelogic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor movecorelogic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of movecorelogic" ). 
...
%-------------------------------------------------
%  User static rules about movecorelogic
%------------------------------------------------- 
robotCanMove.
/*
------------------------------------------------------------------------
