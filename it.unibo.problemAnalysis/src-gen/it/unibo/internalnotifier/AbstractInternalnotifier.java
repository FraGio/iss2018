...
public abstract class AbstractInternalnotifier extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractInternalnotifier(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/internalnotifier/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/internalnotifier/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "internalnotifier tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"internalnotifier START\"";
	    	println( temporaryStr );  
	     connectToMqttServer("tcp://localhost:1883");
	    	//switchTo waitForRequest
	        switchToPlanAsNextState(pr, myselfName, "internalnotifier_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"internalnotifier_"+myselfName,false,
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("handleRequestTimeAndTemperature",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("temperatureTimeProviderResponse") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			String parg = "V";
	    			/* Print */
	    			parg =  updateVars( Term.createTerm("temperatureTimeProviderResponse(V,T)"), 
	    			                    Term.createTerm("temperatureTimeProviderResponse(V,T)"), 
	    				    		  	Term.createTerm(currentEvent.getMsg()), parg);
	    			if( parg != null ) println( parg );
	    	}
	    	//switchTo startPolling
	        switchToPlanAsNextState(pr, myselfName, "internalnotifier_"+myselfName, 
	              "startPolling",false, true, null); 
