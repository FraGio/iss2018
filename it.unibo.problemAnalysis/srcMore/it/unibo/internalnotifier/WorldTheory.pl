%==============================================
% WorldTheory.pl for actor internalnotifier
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuinternalnotifier).	%%old version (deprecated)
actorobj(qatuinternalnotifier).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor internalnotifier
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of internalnotifier" ). 
...
%-------------------------------------------------
%  User static rules about internalnotifier
%------------------------------------------------- 
/*
------------------------------------------------------------------------
