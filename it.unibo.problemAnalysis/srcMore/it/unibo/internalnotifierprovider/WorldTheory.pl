%==============================================
% WorldTheory.pl for actor internalnotifierprovider
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuinternalnotifierprovider).	%%old version (deprecated)
actorobj(qatuinternalnotifierprovider).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor internalnotifierprovider
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of internalnotifierprovider" ). 
...
%-------------------------------------------------
%  User static rules about internalnotifierprovider
%------------------------------------------------- 
/*
------------------------------------------------------------------------
