%==============================================
% WorldTheory.pl for actor timeinternalprovider
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutimeinternalprovider).	%%old version (deprecated)
actorobj(qatutimeinternalprovider).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor timeinternalprovider
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of timeinternalprovider" ). 
...
%-------------------------------------------------
%  User static rules about timeinternalprovider
%------------------------------------------------- 
/*
------------------------------------------------------------------------
