...
\section{Goals}
\labelsec{Goals}
L'obbiettivo principale è progettare e produrre software di qualità.
%===========================================================================
...
Il linguaggio per descrivere il modello (QActor) risulta, in questo caso, un po' limitato per modellare le entità in gioco. Infatti non possiede il concetto di utente esterno.
