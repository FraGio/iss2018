...
public abstract class AbstractVirtualrobot3 extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractVirtualrobot3(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/virtualrobot3/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/virtualrobot3/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "virtualrobot3 tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"virtualrobot START\"";
	    	println( temporaryStr );  
	    	//switchTo waitForEvents
	        switchToPlanAsNextState(pr, myselfName, "virtualrobot3_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"virtualrobot3_"+myselfName,false,
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("handleEvent",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("robotCmd") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			String parg = "\"robot virtuale avviato\"";
	    			/* Print */
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("robotCmd") && 
	    		pengine.unify(curT, Term.createTerm("robotCmd(X)")) && 
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			String parg = "\"robot virtuale arrestato\"";
	    			/* Print */
	    			parg =  updateVars( Term.createTerm("robotCmd(X)"), 
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"virtualrobot3_"+myselfName,false,true);
