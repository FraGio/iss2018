%==============================================
% WorldTheory.pl for actor virtualrobot4
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualrobot4).	%%old version (deprecated)
actorobj(qatuvirtualrobot4).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualrobot4
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualrobot4" ). 
...
%-------------------------------------------------
%  User static rules about virtualrobot4
%------------------------------------------------- 
/*
------------------------------------------------------------------------
