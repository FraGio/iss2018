%==============================================
% WorldTheory.pl for actor timemitter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutimemitter).	%%old version (deprecated)
actorobj(qatutimemitter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor timemitter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of timemitter" ). 
...
%-------------------------------------------------
%  User static rules about timemitter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
