%==============================================
% WorldTheory.pl for actor realrobot3
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobot3).	%%old version (deprecated)
actorobj(qaturealrobot3).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobot3
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobot3" ). 
...
%-------------------------------------------------
%  User static rules about realrobot3
%------------------------------------------------- 
/*
------------------------------------------------------------------------
