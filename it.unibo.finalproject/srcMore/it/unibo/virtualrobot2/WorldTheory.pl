%==============================================
% WorldTheory.pl for actor virtualrobot2
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualrobot2).	%%old version (deprecated)
actorobj(qatuvirtualrobot2).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualrobot2
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualrobot2" ). 
...
%-------------------------------------------------
%  User static rules about virtualrobot2
%------------------------------------------------- 
/*
------------------------------------------------------------------------
