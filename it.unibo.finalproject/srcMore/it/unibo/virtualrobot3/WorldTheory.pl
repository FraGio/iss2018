%==============================================
% WorldTheory.pl for actor virtualrobot3
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualrobot3).	%%old version (deprecated)
actorobj(qatuvirtualrobot3).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualrobot3
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualrobot3" ). 
...
%-------------------------------------------------
%  User static rules about virtualrobot3
%------------------------------------------------- 
/*
------------------------------------------------------------------------
