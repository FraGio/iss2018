%==============================================
% WorldTheory.pl for actor ledmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledmock).	%%old version (deprecated)
actorobj(qatuledmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledmock" ). 
...
%-------------------------------------------------
%  User static rules about ledmock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
