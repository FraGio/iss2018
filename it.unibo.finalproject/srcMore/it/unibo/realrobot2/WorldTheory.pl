%==============================================
% WorldTheory.pl for actor realrobot2
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobot2).	%%old version (deprecated)
actorobj(qaturealrobot2).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobot2
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobot2" ). 
...
%-------------------------------------------------
%  User static rules about realrobot2
%------------------------------------------------- 
/*
------------------------------------------------------------------------
