%==============================================
% WorldTheory.pl for actor applicationlogictemp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplicationlogictemp).	%%old version (deprecated)
actorobj(qatuapplicationlogictemp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applicationlogictemp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applicationlogictemp" ). 
