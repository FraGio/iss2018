%==============================================
% WorldTheory.pl for actor realrobot4
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobot4).	%%old version (deprecated)
actorobj(qaturealrobot4).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobot4
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobot4" ). 
...
%-------------------------------------------------
%  User static rules about realrobot4
%------------------------------------------------- 
/*
------------------------------------------------------------------------
