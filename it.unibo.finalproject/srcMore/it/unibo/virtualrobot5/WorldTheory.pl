%==============================================
% WorldTheory.pl for actor virtualrobot5
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualrobot5).	%%old version (deprecated)
actorobj(qatuvirtualrobot5).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualrobot5
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualrobot5" ). 
...
%-------------------------------------------------
%  User static rules about virtualrobot5
%------------------------------------------------- 
/*
------------------------------------------------------------------------
