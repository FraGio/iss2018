%==============================================
% WorldTheory.pl for actor applicationlogic2
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplicationlogic2).	%%old version (deprecated)
actorobj(qatuapplicationlogic2).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applicationlogic2
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applicationlogic2" ). 
...
%-------------------------------------------------
%  User static rules about applicationlogic2
%------------------------------------------------- 
