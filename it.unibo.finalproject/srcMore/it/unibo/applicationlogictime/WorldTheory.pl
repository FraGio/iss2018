%==============================================
% WorldTheory.pl for actor applicationlogictime
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplicationlogictime).	%%old version (deprecated)
actorobj(qatuapplicationlogictime).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applicationlogictime
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applicationlogictime" ). 
...
%-------------------------------------------------
%  User static rules about applicationlogictime
%------------------------------------------------- 
limitTimeValueMin( 7).
