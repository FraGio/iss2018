%==============================================
% WorldTheory.pl for actor sonar1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonar1).	%%old version (deprecated)
actorobj(qatusonar1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonar1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonar1" ). 
